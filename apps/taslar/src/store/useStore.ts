...
const STORAGE_KEYS = {
  PROFILE: '@sakintaslar_profile',
  DAILY: '@sakintaslar_daily',
  ARCHIVE: '@sakintaslar_archive',
  STATS: '@sakintaslar_stats',
  LANGUAGE: '@sakintaslar_language',
...
export function useSakinHayvanStore() {
  ...
  // Keşfet'te bir kart (taş detay) AÇILINCA okuma say (kullanıcı isteği:
  // "7 taşa bakınca Yol Başlangıcı rozeti yansın"). AYNI KART GÜNDE 1 KEZ sayılır.
