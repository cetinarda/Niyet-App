...
// Uygulamanın KENDİ paket kimliğine göre (life.sakin.stones). Eskiden Hayvan'dan
...
export const PRODUCT_IDS = {
  mikro: 'life.sakin.stones.mikro.monthly',
  premium: 'life.sakin.stones.premium.yearly',
} as const;
