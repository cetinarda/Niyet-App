export const pt = {
  ...
  animalFinder: {
    headerTitle: 'Encontra a tua pedra',
    intro: {
      title: 'Descobre a tua pedra',
      desc: 'Encontra os cristais alinhados contigo pelo teu signo ou elemento.',
      note: 'Cada pedra carrega a sua própria vibração. Escolhe aquela que te chama, deixa a tua intuição fazer o resto.',
      birthStoneTitle: 'A tua pedra natal',
    ...
    result: {
      ...
      birthLabel: 'Pedra do teu mês de nascimento',
  ...
  profile: {
    ...
    animalGuidance: {
      birthStoneTitle: 'As tuas Pedras de Nascimento',
    ...
    spiritualMap: {
      ...
      topStone: 'A tua pedra protetora',
