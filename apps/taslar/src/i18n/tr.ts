export const tr = {
  ...
  profile: {
    // Onboarding
    onboarding: {
      title: "Sakin Taşlar'a Hoş Geldin",
    ...
    account: {
      ...
      signOutBtn: 'Çıkış',
      licenseTitle: 'Lisans Kodu',
      licensePlaceholder: 'XXXX-XXXX-XXXX',
      licenseApply: 'Uygula',
      licenseSuccess: 'Premium aktifleşti! Sakin ailesine hoş geldin.',
      licenseAlready: 'Bu hesapta premium zaten aktif.',
      licenseInvalid: 'Geçersiz veya kullanılmış kod.',
      licenseNetwork: 'Bağlantı hatası. Tekrar dene.',
      licenseSignInRequired: 'Kodu uygulamak için önce hesabına giriş yap.',
    ...
    animalGuidance: {
      birthStoneTitle: 'Doğum Taşların',
    ...
    notif: {
      ...
      rationaleMessage: "Sakin Taşlar, her sabah 08:00'de günün kartını çekmen için sessiz bir hatırlatma göndersin mi? Bildirim hiçbir şekilde reklam veya pazarlama amacıyla kullanılmaz.",
  ...
  paywall: {
    ...
    mikroTitle: "Taş Rehberi ✦",
    premiumTitle: "Sakin Premium",
    mikroSub: "Taşların rehberliğinin derinine in",
    premiumSub: "Bir hesap. Tüm Sakin app'leri.",
    mikroPlan: "Mikro",
    premiumPlan: "Premium",
    mikroCadence: "ay · sadece Taşlar",
    ...
    features: {
      f1Title: "Doğum Taşın",
      f1Desc: "Doğum ayının taşı, burcuna ve unsuruna uyan kristaller",
      f2Title: "Haftalık Rehberlik",
      f2Desc: "52 haftalık döngünde nerede durduğun ve kişisel yılın",
      f3Title: "Taş Sayfaları",
      f3Desc: "Her taşın özellikleri, kökeni, efsaneleri, çakrası, eşlik eden bitkisi ve kullanımı",
