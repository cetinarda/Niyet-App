...
Platform: iOS + Web
Konsept: Doğum bilgisi → Astroloji + Human Design + Numeroloji + Yıldız Irkı kökeni = "Galaktik Karne" (paylaşılabilir görsel)
Monetization: Free + Premium (haftalık / aylık)
Rakipler: The Pattern, Co-Star, Sanctuary, Stellar
...
```
Doğum saatini yaz, 60 saniyede Galaktik Karne'n hazır.
...
Co-Star sadece astrolojiyi anlatır. The Pattern ilişki dinamiklerine odaklanır. Sanctuary chat üzerinden çalışır. SoulProfile farklı: dört farklı ezoterik sistemi birleştirip sana okul karnesi formatında sunar. Hem ciddi, hem eğlenceli. Story'de paylaşılacak kadar görsel, sabah kahvende okuyacak kadar derin.
...
Karne'ni doğrudan Instagram Story, WhatsApp veya TikTok'a gönder. Estetik tipografi, premium kart tasarımı. Arkadaşlarınla karşılaştır, kim kimdir öğren.

💎 ÜCRETSİZ VS PREMIUM

ÜCRETSİZ:
• Tam Galaktik Karne (tek seferlik)
• Temel burç + Human Design tipi
...
Doğum bilgilerin sadece karne üretimi için kullanılır, üçüncü taraflarla paylaşılmaz. Hesabını istediğin zaman sil.

📲 NASIL ÇALIŞIR?

1. Ad, soyad, doğum tarihi, saati ve yerini gir
...
|---|---|---|---|
| 1 | "Sen aslında kimsin?" | 60 saniyede Galaktik Karne | Karne mockup'ı eğik, parıltı efekti, kullanıcı ismi "ZEYNEP K." görünür |
...
Send your card directly to Instagram Stories, WhatsApp, or TikTok. Premium typography, gradient artwork, story-ready aspect ratio. Compare with your friends. Find out who's a Generator and who's a Projector.

💎 FREE VS PREMIUM

FREE:
• One complete Cosmic Report Card
• Sun sign + Human Design type
• Story-format export

PREMIUM (Weekly / Monthly):
• Unlimited cards (read your friends, partner, parents)
• Compatibility analysis (synastry, made simple)
• Daily transit readings
• Full Human Design Body Graph
• Numerology yearly forecast
• Deep starseed origin report
• Notifications for moon cycles and major transits
• Ad-free

🔮 BUILT FOR

• Anyone who graduated from horoscopes and wants the next layer
• Human Design newcomers who find official sites overwhelming
• Starseeds, lightworkers, and the spiritually curious
• Co-Star fans who want a fresh aesthetic
• The Pattern users curious about Human Design

🛡 PRIVACY FIRST

Your birth data is used only to generate your card. Never sold. Never shared. Delete your account anytime.

📲 HOW IT WORKS

1. Enter name, birth date, time, and city
...
|---|---|---|---|
| 1 | "Who are you, really?" | Your Cosmic Report Card in 60s | Tilted card mockup, glitter, sample name "MAYA R." |
| 2 | "More than your sun sign" | Astrology + Human Design + Numerology + Starseed | 4 icons converging into one card |
| 3 | "Find your star origin" | Pleiadian? Sirian? Arcturian? | Cosmic background, "Starseed: Pleiadian 82%" |
| 4 | "Discover your soul mission" | North Node + Human Design Authority | Detail card "Why you're here this lifetime" |
| 5 | "Story-ready" | One tap to Instagram, TikTok, WhatsApp | iPhone in iPhone, IG Story preview |
| 6 | "Go deeper with Premium" | Compatibility, transits, unlimited cards | Paywall + social proof "★★★★★ 50K+ cards generated" |
...
### 3.3 DE (Almanya)
- **Subtitle:** `Astrologie + Human Design + KI`
- **Keywords:** `astrologie,geburtshoroskop,humandesign,numerologie,sternensaat,nordknoten,plejaden,sirius,seelenplan`
- **Hook satırı:** "Dein kosmisches Zeugnis in 60 Sekunden."

### 3.4 FR (Fransa)
- **Subtitle:** `Astrologie + Human Design + IA`
- **Keywords:** `astrologie,thèmenatal,humandesign,numerologie,starseed,noeud nord,pleiadien,sirien,arcturien,signe`
- **Hook satırı:** "Ton Bulletin Cosmique en 60 secondes."

> Lokalizasyon sırası önerisi (volume vs CPI): **TR → US → BR → ES → DE → FR**. BR ve TR organik viral potansiyeli en yüksek pazarlar (sosyal paylaşım kültürü + spiritüellik ilgisi).
...
| Parametre | TR | US |
|---|---|---|
| Hedef CPI | 12-18 TL ($0.35-0.50) | $2.50-3.50 |
| Günlük bütçe | 600 TL (~$18) | $150 |
| Match type | Broad + Search Match ON | Broad + Search Match ON |
| Negatif KW | `ücretsiz oyun`, `çocuk`, `pokemon`, `tarot fal`, `kuran` | `free game`, `kids`, `tarot reading`, `pokemon`, `dating`, `bible` |
| Ad variations | Default + 2 Custom Product Page (Varyant B / C ile eşleşen) | Default + 2 CPP (Competitor alt / Starseed alt) |

### 4.2 Kampanya: **Competitor**
Amaç: The Pattern, Co-Star, Sanctuary, Stellar arayan kullanıcıyı yakalamak.

Keyword listesi (exact + broad ikili):
- `the pattern`, `the pattern app`, `pattern app`
- `co-star`, `costar`, `co star astrology`, `costar app`
- `sanctuary`, `sanctuary astrology`, `sanctuary app`
- `stellar app`, `stellar astrology`
- (TR) `costar türkçe`, `the pattern uygulaması`
...
### 4.3 Kampanya: **Brand Defense**
Amaç: "soulprofile", "soul profile" arayan kullanıcıyı korumak (rakipler bid'leyebilir).

Keywords: `soulprofile`, `soul profile`, `soul profile app`, `soulprofile karne`, `soulprofile app`
- TR + US ortak, exact match
- Bütçe: TR 100 TL, US $30
- Hedef CPI: ucuz (TR <8 TL, US <$1.50)
- Negatif: yok
- Ad: default (kendi marka mesajı)

### 4.4 Kampanya: **Category**
Amaç: Astroloji / Human Design / Numeroloji genel kategori traffic'i.

Keyword grupları (her grup ayrı ad group):

**Astroloji:**
- TR: `burç`, `burç yorumu`, `doğum haritası`, `astroloji`, `günlük burç`, `yükselen burç`
- US: `astrology`, `birth chart`, `natal chart`, `horoscope`, `daily horoscope`, `rising sign`

**Human Design:**
- TR: `human design`, `humandesign`, `human design türkçe`, `manifestor`, `generator`, `projector`
- US: `human design`, `human design chart`, `manifestor`, `projector`, `generator`, `body graph`

**Numeroloji + Starseed:**
- TR: `numeroloji`, `yaşam yolu sayısı`, `starseed`, `yıldız ırkı`, `plejyen`
- US: `numerology`, `life path number`, `starseed`, `pleiadian`, `lightworker`

| Parametre | TR | US |
|---|---|---|
| Hedef CPI | 15-22 TL ($0.45-0.65) | $3.00-4.50 |
| Günlük bütçe (grup başı) | 200 TL (~$6) | $80 |
...
### 4.5 Toplam ASA Bütçe Özeti (Aylık)

| Kampanya | TR (aylık) | US (aylık) |
|---|---|---|
| Discovery | ~18.000 TL ($540) | $4.500 |
| Competitor | ~12.000 TL ($360) | $6.000 |
| Brand Defense | ~3.000 TL ($90) | $900 |
| Category (3 grup) | ~18.000 TL ($540) | $7.200 |
| **Toplam** | **~51.000 TL ($1.530)** | **~$18.600** |

---

## 5. TikTok Ads Playbook
...
### 5.3 Pixel + Conversion API Event Schema

TikTok Events API + iOS Pixel ortak event mapping:

| Event Name | Trigger | Value | Currency | Notes |
|---|---|---|---|---|
| `app_install` | First launch | 0 | TRY/USD | SKAdNetwork redundancy |
| `complete_registration` | Onboarding done (doğum bilgisi girildi) | 0 | - | Funnel başlangıcı |
| `view_content` | İlk karne reveal'i izledi | 0 | - | Aktivasyon proxy |
| `add_to_wishlist` | Paywall görüldü | 0 | - | Intent sinyali |
| `initiate_checkout` | Premium subscribe butonuna tıkladı | abonelik fiyatı | TRY/USD | - |
| `subscribe` | Apple Receipt validation succeeded | net revenue (komisyon sonrası) | TRY/USD | **Ana optimize event** |
| `purchase` | Subscribe ile aynı, geri uyumluluk için | net revenue | TRY/USD | - |

Conversion API: Server-side gönderim, RevenueCat webhook → SoulProfile backend → TikTok Events API. Apple Receipt validation sonrası tetiklenir, refund event'i geri besler.
...
- Lower-third: kullanıcı ismi + burç + HD tipi
- 3 ayrı oyuncu / influencer ile çekim, A/B test
...
| Kriter | Branch | AppsFlyer | Adjust |
|---|---|---|---|
| iOS SKAdNetwork support | Çok iyi (SKAN 4.0 ready) | Endüstri lideri, postback validation güçlü | Çok iyi |
| Deep linking | En güçlü tarafı (Universal Links, deferred deep links) | İyi (OneLink) | İyi (TrackerToken) |
| Web-to-app | Çok güçlü (Branch Journeys) | Orta | Orta |
| Fiyat | Free tier cömert, 250K MAU'ya kadar ücretsiz | $0.07-0.10 / install (pahalı) | $0.05-0.08 / install |
| TikTok / Meta integration | Tam | Tam | Tam |
| Dashboards / cohort | Orta | En zengin | İyi |
...
1. Bütçe büyüdükçe fraud koruma kritik, Protect360 endüstri standart.
2. Audience'ları (LAL kaynakları) AppsFlyer Audiences ile sync etmek Meta/TikTok integration için daha temiz.
3. Cohort dashboard'ları finance + growth ekibe daha okunabilir.

### 7.3 SKAdNetwork Conversion Value Mapping

iOS 14.5+ için 64-bit conversion value (6-bit = 64 değer) önerisi:

**Strateji:** Funnel + Revenue hybrid encoding.

| CV | Anlam | Trigger |
|---|---|---|
| 0 | Install only, no action | Install + 0-24h hiçbir event |
| 1 | Onboarding started | Doğum bilgisi giriş ekranı açıldı |
| 2 | Onboarding completed | Doğum bilgisi submit |
| 3 | First card generated | Karne render edildi |
| 4 | Card shared | Story/WhatsApp share intent |
| 5-9 | Engagement depth | 2-6 ekrana navigate |
| 10 | Paywall viewed | Paywall impression |
| 11 | Trial started (free trial) | RevenueCat trial signal |
| 12-15 | Trial + N days retention | Day 1, 3, 7 retention buckets |
| 20 | Weekly sub purchased | $/₺ 39 weekly |
| 25 | Monthly sub purchased | $/₺ 119 monthly |
...
Hedef: 110.000-150.000 install/ay, 6.000-8.000 paid sub/ay. Blended CPI ~$0.65, paying CAC ~$11. ROAS hedef 30 gün 0.4x, 90 gün 0.9x, 180 gün 1.4x.
...
- Hedef: blended ROAS 90-gün 0.8x+
...
| # | Test | Variant A (kontrol) | Variant B (öneri) | Beklenen kazanım | KPI |
|---|---|---|---|---|---|
| 1 | App Icon | Galaksi + S harfi | Karne kart minyatürü + parıltı | +%8 tap-through | App Store tap-through |
| 2 | Screenshot 1 başlık | "Sen aslında kimsin?" | "60 saniyede Galaktik Karne" | +%6 conversion | Install conversion |
| 3 | Subtitle | "Astroloji + Human Design + AI" | "Burç, Human Design, Numeroloji" | TR organik daha yüksek | Search keyword rank |
| 4 | Paywall headline | "Premium ile derinleş" | "Karnenin gizli bölümünü aç" | +%12 trial start | Paywall conversion |
| 5 | Paywall pricing display | Aylık 119₺ önce | Haftalık 39₺ önce + "ayda ~119₺" | +%15 weekly take rate | Sub mix |
| 6 | Free karne reveal animasyonu | 2sn fade in | 4sn build-up + ses efekti | +%20 share rate | Share intent / card |
| 7 | Onboarding doğum saati ekranı | Saat zorunlu | "Bilmiyorum" opsiyonu + ~ kullanıcı uyarısı | -%18 drop-off | Onboarding completion |
| 8 | Share template | Sade gradient | Yıldız ırkı bazlı 5 farklı template | +%25 share | Story share rate |
| 9 | Free tier card limiti | 1 karne sonra paywall | 1 karne + 1 uyum analizi sonra paywall | +%10 D7 retention, +%6 conversion | D7 retention, paid conv |
| 10 | First-launch push permission timing | Onboarding sonu hemen | Karne reveal'i izledikten sonra (high emotion) | +%30 opt-in | Push opt-in rate |
...
### 9.2 Test Sonrası Karar Çerçevesi

Bir varyantın "winner" sayılma kriteri:
- p < 0.05 statistical significance (Bayesian: >%95 prob to beat)
- Minimum +%5 lift hedef KPI'da
- Counter-metric negatif değil (örn. paywall conversion arttı ama D7 retention -%10 ise reddet)
- Sample her segment için yeterli (TR + US ayrı bakılır, biri kazanırken diğeri kaybedebilir → segmented rollout)
...
|---|---|---|---|
| Aylık install | 6-8K | 30K | 130K |
| Blended CPI | $0.55 | $0.65 | $0.65 |
| Onboarding completion | 60% | 60% | 62% |
| Free → Paid conversion (D7) | 3.5% | 4.0% | 4.5% |
| Weekly:Monthly mix | 70:30 | 65:35 | 60:40 |
| D30 paid retention | 55% | 60% | 65% |
| Blended CAC (paying) | $14 | $11 | $10 |
| LTV (180-day) | $22 | $24 | $26 |
| LTV:CAC | 1.6 | 2.2 | 2.6 |

---

*Bu playbook canlı bir dokümandır. ASA bid'leri 2 haftada bir, creative refresh 3 haftada bir, paywall test sonuçları aylık review edilmelidir.*
