...
function fallbackSections(
  ...
  return {
    ...
    humanDesign: `Enerji profili pusulan ${report.humanDesign.type} olduğunu söylüyor. Stratejin "${report.humanDesign.strategy}", otoriten ${report.humanDesign.authority}. ${report.humanDesign.profile} profilin hayatı hangi ritimle yaşayacağının haritasıdır. Bu üçlüye sadık kaldığında doğru kararlar zaten içeriden gelir.`,
