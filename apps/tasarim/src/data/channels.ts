...
export const CHANNELS: ChannelInfo[] = [
  ...
  { id: '4-63', gates: [4, 63], centers: ['ajna', 'head'], name: 'Mantık Kanalı', nameEn: 'The Channel of Logic', shortDesc: 'Şüpheden cevaba; düşünmeyi kanıtlama yoluyla yapı kurma.', shortDescEn: 'From doubt to answer; building structure by proving out one\'s thinking.', circuit: 'Kollektif' },
  { id: '5-15', gates: [5, 15], centers: ['sacral', 'g'], name: 'Ritm Kanalı', nameEn: 'The Channel of Rhythm', shortDesc: 'Doğal akışı tutmak; yaşam döngüsünün ritmine uyumlanma.', shortDescEn: 'Holding the natural flow; attuning to the rhythm of the life cycle.', circuit: 'Kollektif' },
  ...
  { id: '7-31', gates: [7, 31], centers: ['g', 'throat'], name: 'Alfa Kanalı', nameEn: 'The Alpha Channel', shortDesc: 'Etkileyici liderlik; "iyisi/kötüsü için" demokratik öncülük.', shortDescEn: 'Influential leadership; democratic guidance \'for better or worse\'.', circuit: 'Kollektif' },
  { id: '9-52', gates: [9, 52], centers: ['sacral', 'root'], name: 'Konsantrasyon Kanalı', nameEn: 'The Channel of Concentration', shortDesc: 'Detaya odaklanma gücü; uzun süreli sabit dikkat.', shortDescEn: 'The power to focus on detail; sustained, steady attention.', circuit: 'Kollektif' },
  ...
  { id: '11-56', gates: [11, 56], centers: ['ajna', 'throat'], name: 'Merak Kanalı', nameEn: 'The Channel of Curiosity', shortDesc: 'Hikaye anlatımı; bir fikri etkileyici biçimde sunma.', shortDescEn: 'Storytelling; presenting an idea in a compelling way.', circuit: 'Kollektif' },
  ...
  { id: '13-33', gates: [13, 33], centers: ['g', 'throat'], name: 'Mütedeyin Tanık', nameEn: 'The Prodigal Witness', shortDesc: 'Geçmişi hatırlama ve aktarma; tanıklık eden ses.', shortDescEn: 'Remembering and relaying the past; the voice that bears witness.', circuit: 'Kollektif' },
  { id: '16-48', gates: [16, 48], centers: ['throat', 'spleen'], name: 'Yetenek / Dalga Boyu', nameEn: 'Talent / The Wavelength', shortDesc: 'Derinliği coşkuyla buluşturmak; ustalığın yeteneğe akışı.', shortDescEn: 'Joining depth with enthusiasm; the flow of mastery into talent.', circuit: 'Kollektif' },
  { id: '17-62', gates: [17, 62], centers: ['ajna', 'throat'], name: 'Kabul / Düzenleme', nameEn: 'Acceptance / Organization', shortDesc: 'Detaylarla görüşü ifade etme; örgütsel bilgiyi paylaşma.', shortDescEn: 'Expressing an opinion with detail; sharing organizational knowledge.', circuit: 'Kollektif' },
  { id: '18-58', gates: [18, 58], centers: ['spleen', 'root'], name: 'Yargı / Düzeltme', nameEn: 'Judgment / Correction', shortDesc: 'Yaşamdan zevk almak için iyileştirme arzusu; yapısal eleştiri.', shortDescEn: 'The drive to improve for the joy of life; structural criticism.', circuit: 'Kollektif' },
  ...
  { id: '29-46', gates: [29, 46], centers: ['sacral', 'g'], name: 'Keşif / Başarı', nameEn: 'Discovery / Success', shortDesc: 'Bedeni hayata teslim etme; doğru zamanda doğru yerde olma.', shortDescEn: 'Surrendering the body to life; being in the right place at the right time.', circuit: 'Kollektif' },
  { id: '30-41', gates: [30, 41], centers: ['solarPlexus', 'root'], name: 'Tanıma Kanalı', nameEn: 'The Channel of Recognition', shortDesc: 'Yeni deneyime hayal kurma enerjisi; arzunun başlatıcı sesi.', shortDescEn: 'The dreaming energy toward new experience; the initiating voice of desire.', circuit: 'Kollektif' },
  ...
  { id: '35-36', gates: [35, 36], centers: ['throat', 'solarPlexus'], name: 'Geçicilik Kanalı', nameEn: 'The Channel of Transitoriness', shortDesc: 'Yeni deneyim açlığı; "her şeyi denemek" güdüsü.', shortDescEn: 'A hunger for new experience; the urge to \'try everything\'.', circuit: 'Kollektif' },
  ...
  { id: '42-53', gates: [42, 53], centers: ['sacral', 'root'], name: 'Olgunluk Kanalı', nameEn: 'The Channel of Maturation', shortDesc: 'Döngüleri başlatıp tamamlama; süreçleri sonuna kadar yaşama.', shortDescEn: 'Beginning and completing cycles; living processes through to the end.', circuit: 'Kollektif' },
  { id: '47-64', gates: [47, 64], centers: ['ajna', 'head'], name: 'Soyutlama Kanalı', nameEn: 'The Channel of Abstraction', shortDesc: 'Geçmişin imgelerini anlama; düşünsel bilmece çözme.', shortDescEn: 'Making sense of images from the past; solving mental puzzles.', circuit: 'Kollektif' },
];
