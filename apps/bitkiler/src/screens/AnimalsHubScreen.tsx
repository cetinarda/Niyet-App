...
const PHOTO_KIND: 'stone' | 'plant' = 'plant';
...
const TXT = {
  ...
  failId:      { tr:'Tanıyamadım: daha net bir fotoğraf dener misin?', en:"I couldn't identify it: try a clearer photo?", de:'Ich konnte es nicht erkennen, klareres Foto?', es:'No pude identificarlo: ¿una foto más clara?', pt:'Não consegui identificar: uma foto mais nítida?', fr:"Je n'ai pas pu l'identifier: une photo plus nette ?", ja:'見分けられませんでしたもっと鮮明な写真で。' },
  errConn:     { tr:'Bağlantı hatası, tekrar dener misin?', en:'Connection error, please try again.', de:'Verbindungsfehler, bitte erneut.', es:'Error de conexión, inténtalo de nuevo.', pt:'Erro de ligação, tenta de novo.', fr:'Erreur de connexion, réessaie.', ja:'接続エラー。もう一度お試しを。' },
  ...
  needClearer: { tr:'Bunu tam seçemedim: biraz daha yakın ve net bir fotoğraf dener misin?', en:"I couldn't quite make it out, try a closer, clearer photo?", de:'Ich konnte es nicht genau erkennen, versuch ein näheres, klareres Foto?', es:'No lo distinguí bien: ¿pruebas una foto más cercana y nítida?', pt:'Não consegui distinguir bem: tenta uma foto mais próxima e nítida?', fr:"Je ne l'ai pas bien distingué: essaie une photo plus proche et nette ?", ja:'はっきり見分けられませんでしたもっと近くで鮮明な写真を試してみて。' },
