export const es = {
  ...
  profile: {
    // Onboarding
    onboarding: {
      title: "Te damos la bienvenida a Sakin Plantas",
    ...
    notif: {
      ...
      rationaleMessage: "¿Quieres que Sakin Plantas te envíe un recordatorio silencioso cada mañana a las 08:00 para sacar tu carta del día? Las notificaciones nunca se usan con fines publicitarios ni de marketing.",
  ...
  paywall: {
    ...
    mikroTitle: "Guía de plantas ✦",
    premiumTitle: 'Sakin Premium',
    mikroSub: "Profundiza en la guía de las plantas",
    premiumSub: 'Una cuenta. Todas las apps Sakin.',
    mikroPlan: 'Micro',
    premiumPlan: 'Premium',
    mikroCadence: "mes · solo Plantas",
    ...
    features: {
      f1Title: "Tu planta natal",
      f1Desc: "La planta de tu mes de nacimiento y las de tu signo y tu elemento",
      f2Title: "Guía semanal",
      f2Desc: "Dónde estás en tu ciclo de 52 semanas y tu año personal",
      f3Title: "Páginas de plantas",
      f3Desc: "Propiedades, origen, mitos, chakra y cómo usar cada planta",
