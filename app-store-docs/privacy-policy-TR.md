...
Uygulama şu anda herhangi bir analitik veya izleme SDK'sı kullanmamaktadır. Gelecekte anonim kullanım istatistikleri toplanacak olursa, bu politika güncellenecek ve kullanıcılardan açık rıza alınacaktır.
...
Uygulama şu anda herhangi bir üçüncü taraf reklam ağı, analitik servisi veya sosyal medya entegrasyonu içermemektedir.

## 5. Veri Güvenliği

Tüm veriler kullanıcının cihazında yerel olarak saklanır. Uygulama, internet bağlantısı gerektiren herhangi bir sunucu iletişimi yapmamaktadır.
