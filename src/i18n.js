export const TRANS = {
  tr: {
    ...
    terms_s4:          "4. ABONELİK VE ÖDEME",
    terms_s4p:         "Sakin, yıllık abonelik modeliyle çalışır ($4.99/yıl). Abonelik Apple Kimliği hesabınızdan tahsil edilir ve dönem bitiminden en az 24 saat önce iptal edilmezse otomatik olarak yenilenir. Aboneliklerinizi Ayarlar > Apple Kimliği > Abonelikler bölümünden yönetebilir ve iptal edebilirsiniz. İade talepleri Apple'ın iade politikası kapsamında değerlendirilir. Web üzerinden satın alımlar LemonSqueezy altyapısı ile gerçekleştirilir.",
  ...
  en: {
    ...
    terms_s4:          "4. SUBSCRIPTION AND PAYMENT",
    terms_s4p:         "Sakin operates on a yearly subscription model ($4.99/year). Payment is charged to your Apple ID account and automatically renews unless canceled at least 24 hours before the end of the current period. You can manage and cancel your subscriptions in Settings > Apple ID > Subscriptions. Refund requests are handled under Apple's refund policy. Web purchases are processed via LemonSqueezy.",
