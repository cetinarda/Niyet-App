export const TRANS = {
  tr: {
    ...
    terms_s4p:         "Sakin, App Store üzerinden $4.99 tek seferlik ödemeyle satın alınan ücretli bir uygulamadır. Satın alma sonrası tüm özellikler sınırsız olarak kullanılabilir. Uygulama içi ek satın alma bulunmamaktadır. Tüm gelecek güncellemeler ücretsizdir. İade talepleri Apple'ın iade politikası kapsamında değerlendirilir. Web üzerinden satın alımlar LemonSqueezy altyapısı ile gerçekleştirilir.",
  ...
  en: {
    ...
    terms_s4p:         "Sakin is a paid application purchased as a one-time $4.99 payment through the App Store. After purchase, all features are available without limits. There are no additional in-app purchases. All future updates are free. Refund requests are handled under Apple's refund policy. Web purchases are processed via LemonSqueezy.",
