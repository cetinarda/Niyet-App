...
export const TRANS = {
  tr: {
    ...
    waitlist_cta: "Listeye Gir →",
    waitlist_joined: "İlgin kaydedildi ✓",
    waitlist_joined_sub: "Hazır olduğumuzda ilk sen haberdar olacaksın.",
  ...
  en: {
    ...
    waitlist_joined: "You're on the list ✓",
    waitlist_joined_sub: "You'll be the first to know when we're ready.",
