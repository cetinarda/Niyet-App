...
export const TRANS = {
  tr: {
    ...
    ailesi_hayvan_desc: "Sözler, Taşlar, Nagual — Anadolu bilgeliği ve ruh rehberliği üzerinden günlük üç kart çekimi.",
    ailesi_mitler_desc: "Jung'un izinde günlük arketip, mit ve imge okuması — her gün üç deste açılır.",
    ailesi_tasarim_desc: "Doğum gün, saat ve şehrini girerek Human Design haritan — tip, içsel yetki, profil, merkezler ve kanallar.",
  ...
  en: {
    ...
    ailesi_hayvan_desc: "Words, Stones, Nagual — daily three-card draws through Anatolian wisdom and spirit guidance.",
    ailesi_mitler_desc: "Daily archetype, myth and image reading in the footsteps of Jung — three decks open each day.",
    ailesi_tasarim_desc: "Your Human Design chart from birth date, time and city — type, inner authority, profile, centers and channels.",
    ...
    mirror_ask_heart: "Ask Your Heart",
