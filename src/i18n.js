export const TRANS = {
  tr: {
    ...
    close_eyes_hint:   "Şimdi gözlerini kapayabilirsin dilersen.",
    connected_label:   "● BAĞLANTI KURULDU",
    ...
    nav_baglan:           "Bağlan",
    baglan_sup:           "✦ CANLI ✦",
    baglan_title:         "Topluluk",
    baglan_sub:           "ŞUAN SENINLE",
    baglan_live_count:    (n) => `${n} kişi`,
    baglan_live_desc:     "şu an bu uygulamayı açık tutuyor",
    baglan_energy_label:  "KOLEKTIF ENERJİ",
    baglan_energy_sub:    "Bugün topluluğun odaklandığı çakra",
    baglan_words_label:   "BU HAFTA TOPLULUKTAN",
    baglan_words_sub:     "En çok seçilen niyet kelimeleri",
    baglan_breath_label:  "ORKESTRA MODU",
    baglan_breath_sub:    "Toplulukla birlikte nefes al",
    baglan_breath_join:   "KATIL",
    baglan_breath_leave:  "AYRIL",
    baglan_breath_active: (n) => `${n} kişi seninle nefes alıyor`,
    baglan_inhale:        "al",
    baglan_exhale:        "ver",
    baglan_hold:          "tut",
    baglan_intentions_label: "BUGÜNÜN NİYETLERİ",
    baglan_intentions_sub:   "Topluluktan anonim paylaşımlar",
    baglan_you_badge:     "sen",
    baglan_pulse_label:   "NABIZ",
  },
  ...
  en: {
    ...
    nav_baglan:           "Connect",
    baglan_sup:           "✦ LIVE ✦",
    baglan_title:         "Community",
    baglan_sub:           "WITH YOU RIGHT NOW",
    baglan_live_count:    (n) => `${n} people`,
    baglan_live_desc:     "have this app open right now",
    baglan_energy_label:  "COLLECTIVE ENERGY",
    baglan_energy_sub:    "Today's community focus chakra",
    baglan_words_label:   "FROM THE COMMUNITY THIS WEEK",
    baglan_words_sub:     "Most chosen intention words",
    baglan_breath_label:  "ORCHESTRA MODE",
    baglan_breath_sub:    "Breathe together with the community",
    baglan_breath_join:   "JOIN",
    baglan_breath_leave:  "LEAVE",
    baglan_breath_active: (n) => `${n} people breathing with you`,
    baglan_inhale:        "inhale",
    baglan_exhale:        "exhale",
    baglan_hold:          "hold",
    baglan_intentions_label: "TODAY'S INTENTIONS",
    baglan_intentions_sub:   "Anonymous shares from the community",
    baglan_you_badge:     "you",
    baglan_pulse_label:   "PULSE",
  },
};
