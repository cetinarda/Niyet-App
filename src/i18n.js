export const TRANS = {
  tr: {
    ...
    connected_voice:   (name) => `${name} çakrana bağlandın. İhtiyacın kadar enerji aktarabilirsin. İhtiyacının ne kadar olduğunu kalbine sor.`,
  ...
  en: {
    ...
    connected_voice:   (name) => `You are now connected to your ${name} chakra. Transfer as much energy as you need. Ask your heart how much you need.`,
