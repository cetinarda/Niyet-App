export const TRANS = {
  tr: {
    ...
    paid_app_features: ["Sabah niyeti ve motivasyon kelimeleri","7 farklı nefes egzersizi tekniği","10 solfeggio frekansı ve kuş sesleri","22 Çakra Farkındalığı","İçsel Ayna — AI destekli kişisel yansıtma","Haftalık AI içsel rapor","Gün içi hatırlatıcılar (10+)","Akşam kapanış ritüeli","Haftalık iç harita ve istatistikler","Numeroloji & astroloji detayları","Farkındalık rehberi","Süresiz erişim — güncelleme dahil"],
