export const TRANS = {
  tr: {
    ...
    solfeggio_what:    "Solfeggio Frekansları Nedir?",
    solfeggio_desc:    "Solfeggio frekansları, antik müzik geleneğinde kullanılan ve her birinin farklı titreşimsel etki yarattığına inanılan tonlardır. 396 Hz korkuyu serbest bırakmaya, 528 Hz dönüşüme, 741 Hz ifadeye, 963 Hz birlik bilincine bağlanmaya yardımcı olduğu söylenir. Bilimsel kanıt sınırlıdır; deneyimsel ve gevşeme amaçlıdır.",
    ...
    chakra_what:       "Çakra Nedir?",
    chakra_what_desc:  "Çakralar, antik Hint Veda geleneğinde (MÖ 1500-500) tanımlanan, bedendeki enerji merkezleridir. Temel 7 çakra omurga boyunca dizilir ve her biri farklı yaşam alanlarıyla bağlantılıdır: güvenlik, yaratıcılık, irade, sevgi, ifade, sezgi ve ilahi bağlantı. Yüksek frekans çakralar (8-22) bedenin üzerinde konumlanır. Geleneksel enerji felsefesinden alınmış bilgilerdir; tıbbi tedavi yerine geçmez.",
    core_badge:        "temel",
    ...
    connected_flow:    "Artık istediğin kadar burada kalabilirsin.\nGözlerini kapatarak enerjinin akmasına izin ver.",
    ...
    paid_app_price:    "$19.99",
    paid_app_price_sub:"Bir kez öde, ömür boyu seninle. Abonelik yok.",
    paid_app_features: ["Sabah niyeti ve motivasyon kelimeleri","7 farklı nefes egzersizi tekniği","10 solfeggio frekansı ve kuş sesleri","22 Çakra Farkındalığı","İçsel Ayna — AI destekli kişisel yansıtma","Haftalık AI içsel rapor","Gün içi hatırlatıcılar (10+)","Akşam kapanış ritüeli","Tüm güncellemeler dahil","Süresiz erişim — abonelik yok"],
    ...
    sub_badge:         "YILLIK",
    sub_plan:          "Sakin — Tüm Özellikler",
    sub_price:         "$4.99/yıl",
    sub_price_desc:    "Yıllık olarak otomatik yenilenir. Tüm güncellemeler dahil.",
    sub_buy:           "Abone Ol",
    sub_restore:       "Satın Alımları Geri Yükle",
    sub_terms_text:    "Ödeme Apple Kimliği hesabınızdan tahsil edilir. Abonelik, dönem bitiminden en az 24 saat önce iptal edilmezse otomatik olarak yenilenir. Aboneliklerinizi Ayarlar > Apple Kimliği > Abonelikler bölümünden yönetebilirsiniz.",
    sub_active:        "Abonelik Aktif",
    sub_active_desc:   "Tüm özellikler sınırsız kullanımınıza açık.",
    sub_features:      ["Sabah niyeti ve motivasyon kelimeleri","7 farklı nefes egzersizi","10 solfeggio frekansı ve kuş sesleri","22 Çakra Farkındalığı","İçsel Ayna — AI destekli yansıtma","Haftalık AI içsel rapor","Gün içi hatırlatıcılar","Akşam kapanış ritüeli","Tüm güncellemeler dahil"],
    sub_no_subscription:"Aktif abonelik bulunamadı",
    sub_yearly_badge:  "EN POPÜLER",
    sub_yearly_price:  "$4.99/yıl",
    sub_yearly_desc:   "Yıllık otomatik yenilenir",
    sub_lifetime_badge:"ÖMÜR BOYU",
    sub_lifetime_price:"$19.99",
    sub_lifetime_desc: "Tek seferlik, sonsuza kadar",
    sub_no_purchase:   "Aktif satın alım bulunamadı",
    sub_paywall_title: "Sakin Premium",
    sub_paywall_desc:  "Tüm özelliklere erişim için\npremium'a geç.",
    ...
    terms_s4:          "4. ABONELİK VE SATIN ALMA",
    terms_s4p:         "Sakin, App Store üzerinden ücretsiz indirilen ve uygulama içi satın alma ile premium özelliklere erişim sağlayan bir uygulamadır. İki plan sunulmaktadır: Yıllık abonelik ($4.99/yıl, otomatik yenilenir) ve Ömür Boyu Lisans ($19.99, tek seferlik). Abonelik, dönem bitiminden en az 24 saat önce iptal edilmezse otomatik olarak yenilenir. Aboneliklerinizi Ayarlar > Apple Kimliği > Abonelikler bölümünden yönetebilirsiniz. İade talepleri Apple'ın iade politikası kapsamında değerlendirilir. Web üzerinden satın alımlar LemonSqueezy altyapısı ile gerçekleştirilir.",
  ...
  en: {
    ...
    solfeggio_what:    "What are Solfeggio Frequencies?",
    solfeggio_desc:    "Solfeggio frequencies are tones used in ancient music tradition, each believed to create different vibrational effects. 396 Hz is said to help release fear, 528 Hz transformation, 741 Hz expression, 963 Hz connecting to unity consciousness. Scientific evidence is limited; intended for experiential and relaxation purposes.",
    ...
    chakra_what:       "What is a Chakra?",
    chakra_what_desc:  "Chakras are energy centers in the body defined in the ancient Indian Vedic tradition (1500-500 BCE). The core 7 chakras align along the spine and each connects to different life areas: safety, creativity, willpower, love, expression, intuition and divine connection. Higher frequency chakras (8-22) are located above the body. Information drawn from traditional energy philosophy; not a substitute for medical treatment.",
    core_badge:        "CORE",
    ...
    connected_flow:    "You can stay here as long as you wish.\nClose your eyes and let the energy flow.",
    connected_voice:   () => "Connected",
    ...
    paid_app_features: ["Morning intention and motivation words","7 different breathing techniques","10 solfeggio frequencies with bird sounds","22 Chakra Awareness","Inner Mirror — AI-powered personal reflection","Weekly AI inner report","Daily reminders (10+)","Evening closing ritual","All updates included","Lifetime access — no subscription"],
    pricing_footer:    "Purchased securely via our payment provider. For questions:",
    lemon_checkout_url:"https://sakin.lemonsqueezy.com/checkout/buy/0fbd6f22-0ad0-4078-93b7-3f873912e1e2",
    sub_badge:         "YEARLY",
    sub_plan:          "Sakin — All Features",
    sub_price:         "$4.99/year",
    sub_price_desc:    "Auto-renews yearly. All updates included.",
    sub_buy:           "Subscribe",
    sub_restore:       "Restore Purchases",
    sub_terms_text:    "Payment is charged to your Apple ID account. Subscription automatically renews unless canceled at least 24 hours before the end of the current period. Manage subscriptions in Settings > Apple ID > Subscriptions.",
    sub_active:        "Subscription Active",
    sub_active_desc:   "All features are unlocked.",
    sub_features:      ["Morning intention and motivation words","7 different breathing techniques","10 solfeggio frequencies with bird sounds","22 Chakra Awareness","Inner Mirror — AI-powered reflection","Weekly AI inner report","Daily reminders","Evening closing ritual","All updates included"],
    sub_no_subscription:"No active subscription found",
    sub_yearly_badge:  "MOST POPULAR",
    sub_yearly_price:  "$4.99/year",
    sub_yearly_desc:   "Auto-renews yearly",
    sub_lifetime_badge:"LIFETIME",
    sub_lifetime_price:"$19.99",
    sub_lifetime_desc: "One-time, forever yours",
    sub_no_purchase:   "No active purchase found",
    sub_paywall_title: "Sakin Premium",
    sub_paywall_desc:  "Unlock all features\nwith Premium.",
    ...
    terms_s4:          "4. SUBSCRIPTION & PURCHASE",
    terms_s4p:         "Sakin is a free-to-download application with premium features accessible via in-app purchase. Two plans are offered: Yearly subscription ($4.99/year, auto-renews) and Lifetime License ($19.99, one-time). Subscription automatically renews unless canceled at least 24 hours before the end of the current period. Manage subscriptions in Settings > Apple ID > Subscriptions. Refund requests are handled under Apple's refund policy. Web purchases are processed via LemonSqueezy.",
