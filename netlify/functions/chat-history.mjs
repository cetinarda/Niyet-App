...
import { chatConfig, corsFor, json, rest, ROOMS, HISTORY_HOURS, elementIndex } from "./_chat.mjs";
...
export default async (req) => {
  ...
  const msgs = r.data.reverse().map((m) => ({ id: m.id, nick: m.nick, body: m.body, t: m.created_at, el: elementIndex(m.device_hash) }));
